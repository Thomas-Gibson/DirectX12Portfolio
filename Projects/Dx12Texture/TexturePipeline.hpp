...
public:
	TexturePipeline(const Dx12Framework::Dx12DeviceContext& dc) {
		// Create Root signature
		Microsoft::WRL::ComPtr<ID3DBlob> VertexShader, Pixelshader;
		{
			ThrowIfFailed(D3DReadFileToBlob(L"Dx12Texture/Dx12Textures_VertexShader.cso", VertexShader.GetAddressOf()));
			ThrowIfFailed(D3DReadFileToBlob(L"Dx12Texture/Dx12Textures_PixelShader.cso", Pixelshader.GetAddressOf()));
